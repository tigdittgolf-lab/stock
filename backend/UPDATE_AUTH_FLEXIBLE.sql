-- =====================================================
-- MISE À JOUR : Authentification flexible (email OU username)
-- =====================================================

-- Supprimer l'ancienne fonction
DROP FUNCTION IF EXISTS authenticate_user(VARCHAR, VARCHAR);

-- Recréer avec support email OU username
...
DO $$
BEGIN
    RAISE NOTICE '✅ Fonction authenticate_user mise à jour avec succès !';
    RAISE NOTICE '📝 Accepte maintenant email OU username';
END $$;

-- CORRECTION DES FONCTIONS CLIENTS - À EXÉCUTER DANS SUPABASE
...
DROP FUNCTION IF EXISTS insert_client_to_tenant(text, varchar, varchar, text, varchar, varchar, varchar, varchar, varchar, decimal, decimal);
DROP FUNCTION IF EXISTS update_client_in_tenant(text, varchar, varchar, text, varchar, varchar, varchar, varchar, varchar, decimal, decimal);
DROP FUNCTION IF EXISTS delete_client_from_tenant(text, varchar);

-- 2. Recréer les fonctions avec les bons types

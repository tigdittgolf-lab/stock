...
-- Version corrigée pour l'architecture multi-tenant
...
DECLARE
  ...
  sql_query TEXT;
BEGIN
  -- Construire la requête dynamique avec le nom du schéma
  sql_query := format('
    ...
    LIMIT 1',
    p_tenant, p_tenant, p_tenant, p_tenant, p_tenant, p_tenant, p_tenant, p_tenant, p_tenant, p_tenant
  );

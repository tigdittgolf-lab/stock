...
function getSupabase() { return createClient(process.env.SUPABASE_URL || process.env.NEXT_PUBLIC_SUPABASE_URL || '', process.env.SUPABASE_SERVICE_ROLE_KEY || ''); }
const supabase = new Proxy({} as ReturnType<typeof getSupabase>, { get: (_t, p) => (getSupabase() as any)[p] });

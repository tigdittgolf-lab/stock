// EXEMPLE D'INTÉGRATION COMPLÈTE - Système de suivi des paiements
// Ce fichier montre comment intégrer les composants de paiement dans une page de détail de bon de livraison
// Copiez les parties pertinentes dans votre page existante
...
// ✅ NOUVEAUTÉ : Import des composants de paiement
...
export default function DeliveryNoteDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  // ✅ NOUVEAUTÉ : États pour les modals de paiement
  ...
  // ✅ NOUVEAUTÉ : Fonction pour rafraîchir les paiements
  const handlePaymentSuccess = () => {
    setShowPaymentForm(false);
    setRefreshPaymentTrigger(prev => prev + 1);
  };

  // ✅ NOUVEAUTÉ : Fonction pour rafraîchir après modification/suppression
    ...
    <div className={styles.page}>
      <header className={styles.header}>
        ...
        <div>
          ...
          {/* ✅ NOUVEAUTÉ : Bouton pour enregistrer un paiement */}
          <button 
      ...
      <main className={styles.main}>
        <div>
          {/* ✅ NOUVEAUTÉ : Widget de résumé des paiements */}
          ...
          <div className={styles.totalsSection}>
            <div className={styles.totalsGrid}>
              ...
              <div className={styles.totalRow}>
                ...
                <strong>
                  {calculateTotalTTC().toLocaleString('fr-FR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} DA
                </strong>
              </div>
            </div>
          </div>
      ...
      {/* ✅ NOUVEAUTÉ : Modal de formulaire de paiement */}
      {showPaymentForm && (
        <div style={{
          position: 'fixed',
          top: 0,
      ...
      {/* ✅ NOUVEAUTÉ : Modal d'historique des paiements */}
      {showPaymentHistory && (
        <div style={{
          position: 'fixed',
          top: 0,

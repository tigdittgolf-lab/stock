...
interface InvoiceActionsProps {
  invoiceId: number;
  clientName: string;
  onOpenPDF: (id: number, type: 'invoice') => void;
}
  ...
  return (
    <div style={{
      ...
      <button
        ...
        title={`Voir les détails de la facture ${invoiceId}`}
      >
        👁️ Voir
      </button>
      ...
      <div ref={menuRef} style={{ position: 'relative', display: 'inline-block' }}>
        ...
        {showMenu && (
          <div style={menuStyle}>
            ...
            <button
              onClick={() => {
                router.push(`/returns/new?type=invoice&id=${invoiceId}`);
                setShowMenu(false);
              }}
              style={{
                width: '100%',
